...
public class ManagerFilters {
    ...
    public static var TEXT_MAX_BLUE:int = 0x0184df;
    ...
    public static var TEXT_STROKE_LIGHT_BLUE:Array = [new GlowFilter(TEXT_LIGHT_BLUE, 1, 4, 4, 5)];
    ...
    public static var TEXT_STROKE_BROWN_BIG:Array = [new GlowFilter(TEXT_BROWN, 1, 6, 6, 5)];
    public static var TEXT_STROKE_BLUE_BIG:Array = [new GlowFilter(TEXT_BLUE, 1, 6, 6, 5)];
    public static var TEXT_STROKE_GREEN_BIG:Array = [new GlowFilter(TEXT_GREEN, 1, 6, 6, 5)];
