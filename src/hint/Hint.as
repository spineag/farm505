...
public class Hint {
    ...
    public function Hint() {
        ...
        _txtHint.setFormat(CTextField.MEDIUM18, 15, Color.WHITE, ManagerFilters.TEXT_BLUE_COLOR);
        _txtHintTime = new CTextField(150,20,"");
        _txtHintTime.setFormat(CTextField.MEDIUM18, 15, Color.WHITE, ManagerFilters.TEXT_BLUE_COLOR);
