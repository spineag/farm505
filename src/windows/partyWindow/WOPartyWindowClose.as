...
public class WOPartyWindowClose extends WindowMain{
    ...
    public function WOPartyWindowClose() {
        _woHeight = 451;
        _woWidth = 695;
        g.load.loadImage(g.dataPath.getGraphicsPath() + 'qui/end_gnoom_window.png',onLoad);
    }

    private function onLoad(bitmap:Bitmap):void {
        var st:String = g.dataPath.getGraphicsPath();
        bitmap = g.pBitmaps[st + 'qui/end_gnoom_window.png'].create() as Bitmap;
    ...
    private function photoFromTexture(tex:Texture):void {
        ...
        _txtResource = new CTextField(701, 172, 'Вы собрали ' + g.managerParty.userParty.countResource + ' кукурузного хлеба.');
...
//        _txtResource.alignH = Align.LEFT;
        ...
        _txtText = new CTextField(701, 172, 'Событие "Семейка Гномов" завершено.');
