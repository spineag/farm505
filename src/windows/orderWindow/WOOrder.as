...
//                    g.woNoResources.showItOrder(_activeOrderItem.getOrder(), sellOrder);
        ...
        if (g.managerParty && !g.managerParty.userParty.showWindow && g.userTimer.partyTimer > 0) new DropPartyResource(g.managerResize.stageWidth/2, g.managerResize.stageHeight/2, prise);
