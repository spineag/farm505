...
//    private var _txtHelp:TextField;
    ...
    public function WOTrain() {
        ...
        _txtCounter.filter = ManagerFilters.TEXT_STROKE_BROWN;
        _txtCounter.x = 110;
        _txtCounter.y = 130;
    ...
    private function createRightBlock():void {
        ...
        _txtLoad.filter = ManagerFilters.TEXT_STROKE_BROWN;
        _txtLoad.x = 25;
        _txtLoad.y = 5;
...
//        _btnHelp.addChild(_txtHelp);
        ...
        _txtCostItem.filter = ManagerFilters.TEXT_STROKE_BROWN;
        _txtCostItem.x = 226;
        _txtCostItem.y = 80;
        ...
        _txtXpItem.filter = ManagerFilters.TEXT_STROKE_BROWN;
        _txtXpItem.x = 155;
        _txtXpItem.y = 80;
        ...
        _txtCostAll.filter = ManagerFilters.TEXT_STROKE_BROWN;
        _txtCostAll.x = 160;
        _txtCostAll.y = 280;
        ...
        _txtXpAll.filter = ManagerFilters.TEXT_STROKE_BROWN;
        _txtXpAll.x = 75;
        _txtXpAll.y = 280;
