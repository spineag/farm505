...
public class WOServerError extends WindowMain {
    ...
    public function WOServerError() {
        ...
        var txt:TextField = new TextField(420,80,'Произошла ошибка в игре. Если подобное происходит часто, обратитесь в службу поддержки.',g.allData.bFonts['BloggerMedium18'],18,Color.WHITE);
        txt.autoScale = true;
        ...
        _txtError = new TextField(340,100,'Ошибка Сервера',g.allData.bFonts['BloggerBold24'],22,Color.WHITE);
        _txtError.nativeFilters = ManagerFilters.TEXT_STROKE_BLUE;
        _txtError.x = -170;
        _txtError.y = -170;
        _source.addChild(_txtError);
        _txtErrorNew = new TextField(420,100,'',g.allData.bFonts['BloggerBold24'],22,Color.WHITE);
        ...
        _b.y = 120;
        _source.addChild(_b);
        txt = new TextField(200, 34, "Перезагрузить", g.allData.bFonts['BloggerMedium18'], 16, Color.WHITE);
