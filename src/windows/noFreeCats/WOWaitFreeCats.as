...
public class WOWaitFreeCats extends WindowMain{
    ...
    public function WOWaitFreeCats() {
        ...
        txt = new TextField(400,100,'Все помощники сейчас заняты! Подождите окончания другого производства!',g.allData.bFonts['BloggerBold18'],18,Color.WHITE);
        txt.x = -200;
        txt.y = -120;
        txt.nativeFilters = ManagerFilters.TEXT_STROKE_BLUE;
        txt.touchable = false;
        ...
        txt = new TextField(130, 40, "ОК",g.allData.bFonts['BloggerBold18'],18,Color.WHITE);
