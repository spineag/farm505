...
public class WOBuyPlantItem {
    ...
    public function fillData(ob:Object, f:Function):void {
        ...
        if (g.managerTutorial && (g.managerTutorial.currentAction == TutorialAction.PLANT_WHEAT || g.managerTutorial.currentAction == TutorialAction.PLANT_CORN) && g.managerTutorial.isTutorialResoucre(_dataPlant.id)) {
            addArrow();
        }
    }
