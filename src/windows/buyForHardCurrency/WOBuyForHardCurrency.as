...
public class WOBuyForHardCurrency extends WindowMain {
    ...
    public function WOBuyForHardCurrency() {
        ...
        im.x = -50;
        im.y = -60;
        txt = new TextField(300,50,"Подтвердить покупку за рубины?",g.allData.bFonts['BloggerMedium18'],18,Color.WHITE);
        txt.nativeFilters = ManagerFilters.TEXT_STROKE_BLUE;
        txt.x = -150;
        txt.y = -100;
        _source.addChild(txt);
        txt = new TextField(300,30,"ПОДТВЕРЖДЕНИЕ ПОКУПКИ!",g.allData.bFonts['BloggerBold24'],22,Color.WHITE);
        txt.nativeFilters = ManagerFilters.TEXT_STROKE_BLUE;
        txt.x = -150;
        txt.y = -115;
        txt.nativeFilters = ManagerFilters.TEXT_STROKE_BLUE;
