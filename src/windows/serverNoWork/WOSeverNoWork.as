...
public class WOSeverNoWork  extends WindowMain {
    ...
    public function WOSeverNoWork() {
        ...
        var txt:TextField = new TextField(420,80,'Не удалось получить ответ от сервера!',g.allData.fonts['BloggerMedium'],18,Color.WHITE);
        txt.autoScale = true;
        ...
        _txtError = new TextField(340,100,'Ошибка соединения!',g.allData.fonts['BloggerBold'],22,Color.WHITE);
