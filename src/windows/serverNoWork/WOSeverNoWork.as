...
public class WOSeverNoWork  extends WindowMain {
    ...
    public function WOSeverNoWork() {
        ...
        var txt:TextField = new TextField(420,80,'Не удалось получить ответ от сервера!',g.allData.bFonts['BloggerMedium18'],18,Color.WHITE);
        txt.autoScale = true;
        ...
        _txtError = new TextField(340,100,'Ошибка соединения!',g.allData.bFonts['BloggerBold24'],22,Color.WHITE);
