...
public class WOInviteFriendsItem {
    ...
    public function WOInviteFriendsItem(data:Object) {
        ...
        var txt:TextField = new TextField(100,100,data.name + ' ' + data.lastName, g.allData.bFonts['BloggerBold14'], 12, Color.BLACK);
        txt.y = 20;
        source.addChild(txt);
    ...
    private function onLoadPhoto(bitmap:Bitmap):void {
        if (!bitmap) {
            bitmap = g.pBitmaps[_data.photo].create() as Bitmap;
        }
        if (!bitmap) {
