...
public class FriendPanel {
    ...
    public function FriendPanel() {
        ...
        im.y = -23;
        _source.addChild(im);
        var txt:TextField = new TextField(106, 27, "Мои друзья", g.allData.fonts['BloggerBold'], 14, ManagerFilters.TEXT_BROWN_COLOR);
        txt.x = 30;
        txt.y = -23;
...
//        _source.x = Starling.current.nativeStage.stageWidth - 271;
    ...
    public function onGettingInfo(e:SocialNetworkEvent):void {
        ...
        if (_arrFriends.length == 0 ) {
            ...
            txt = new TextField(64, 50,"Добавить друга", g.allData.fonts['BloggerBold'], 12, ManagerFilters.TEXT_BROWN_COLOR);
            txt.x = -1;
            txt.y = 12;
            bt.addChild(txt);
            bt.setPivots();
