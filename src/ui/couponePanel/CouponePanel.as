...
public class CouponePanel {
    ...
    public function CouponePanel() {
        ...
        _txtGreen.setFormat(CTextField.BOLD18, 18, Color.WHITE, ManagerFilters.BROWN_COLOR);
        _txtGreen.x = 55;
        _txtGreen.y = 20;
        _contCoupone.addChild(_txtGreen);
        _txtBlue = new CTextField(50,50,"");
        _txtBlue.setFormat(CTextField.BOLD18, 18, Color.WHITE, ManagerFilters.BROWN_COLOR);
        _txtBlue.x = 80;
        _txtBlue.y = 20;
        _contCoupone.addChild(_txtBlue);
        _txtYellow = new CTextField(50,50,"");
        _txtYellow.setFormat(CTextField.BOLD18, 18, Color.WHITE, ManagerFilters.BROWN_COLOR);
        _txtYellow.x = 105;
        _txtYellow.y = 20;
        _contCoupone.addChild(_txtYellow);
        _txtRed = new CTextField(50,50,"");
        _txtRed.setFormat(CTextField.BOLD18, 18, Color.WHITE, ManagerFilters.BROWN_COLOR);
        _txtRed.x = 130;
        _txtRed.y = 20;
