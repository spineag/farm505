...
package com.junkbyte.console 
{
	...
	public class Console extends Sprite {
		...
		*/
        ...
        public function objectToString(object:*, tab:String = TAB):String {
            var child:*;
            var buffer:String = "";
            ...
            for (var key:String in object) {
                ...
                for (hasParams in child) {
                    break;
                }
                
                if (hasParams) {
                    buffer += tab + key + ": ...\n" + objectToString(child, tab + TAB);
                } else {
                    child = (child is String) ? "\"" + child + "\"" : child;
                    buffer += tab + key + ": " + child + "\n";
                }
                hasParams = "";
            }
            return buffer;
         ...
         */
        public function obj(channel:*, object:*, comment:String, priority:int):void{
            addLine([comment + "\n" + objectToString(object)], priority, channel);
        }
		...
		public function log(...strings):void{
			addLine(strings, ConsoleLevel.LOG, "log");
		}
		...
		public function info(...strings):void{
			addLine(strings, ConsoleLevel.INFO, "info");
		}
		...
		public function debug(...strings):void{
			addLine(strings, ConsoleLevel.DEBUG, "debug");
		}
		...
		public function warn(...strings):void{
			addLine(strings, ConsoleLevel.WARN, "error");
		}
		...
		public function error(...strings):void{
			addLine(strings, ConsoleLevel.ERROR, "error");
		}
		...
		public function fatal(...strings):void{
			addLine(strings, ConsoleLevel.FATAL, "fatal");
		}
