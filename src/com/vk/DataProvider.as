...
public class DataProvider {
    ...
    private var _api_url:String = 'http://api.vk.com/api.php';
    ...
    public function request(method:String, options:Object = null):void {
        ...
        options.onError = options.onError ? options.onError : ((_global_options && _global_options.onError) ? _global_options.onError : null);
    ...
    private function _sendRequest(method:String, options:Object):void {
        ...
        loader.addEventListener(Event.COMPLETE, function (e:Event):void {
            ...
            var data:Object = JSONuse.decode(loader.data);

            if (data.error) {
                options.onError(data.error);
            } else if (options.onComplete && (data.response || data.response == 0)) {
